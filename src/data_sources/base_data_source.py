...
class DataFetcher(ABC):
    ...
    @lru_cache(maxsize=128)  # Cache API responses
    def _cached_request(self, url: str, params: Optional[Dict[str, Any]] = None) -> Optional[Dict[str, Any]]:
        """Cached version of _make_request to avoid redundant API calls."""
